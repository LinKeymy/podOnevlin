...
Pod::Spec.new do |s|
  s.name             = 'podOnevlin'
  s.version          = '0.1.0'
  s.summary          = 'A short description of podOnevlin.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/TouzhijiaAdmi/podOnevlin'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TouzhijiaAdmi' => 'fudanxiaoan@outlook.com' }
  s.source           = { :git => 'https://github.com/TouzhijiaAdmi/podOnevlin.git', :tag => s.version.to_s }
